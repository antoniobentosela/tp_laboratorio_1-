...
void* ll_get(LinkedList* this, int index)
{
    ...
    if(this != NULL && index >= 0 && index < tam)
    {
        ...
        pNode = getNode(this, index);                     //getNode devuelve un puntero al nodo. Y yo necesito un puntero al elemento.

        if(pNode != NULL)
        {

            returnAux = pNode->pElement;                      //pElement es el puntero al elemento.
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this != NULL && index >= 0 && index < tam)
    {
        ...
        actual = getNode(this, index);  //indice a remover.
        ...
        if(actual != NULL)
        {
            ...
            else
            {
                ...
                anterior = getNode(this, index - 1); //indice del anterior a remover.
...
LinkedList* ll_clone(LinkedList* this)
{
    ...
    if(this != NULL)
    {
        ...
        cloneArray = ll_subList(this, 0, ll_len(this));           //Opcion Corta.

        /*cloneArray = ll_newLinkedList();

        if(cloneArray != NULL){                                   //Opcion Larga.
